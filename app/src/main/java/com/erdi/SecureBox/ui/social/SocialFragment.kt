...
class SocialFragment : Fragment() {
    var socialViewModel: SocialViewModel? = null
    var status = false
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.social_fragment, container, false)
        ...
        socialViewModel!!.allSocial.observe(viewLifecycleOwner) { viyCreds ->
        ...
        val itemTouchHelperCallback: ItemTouchHelper.SimpleCallback =
            object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
                ...
                override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                    socialViewModel!!.delete(viewAdapter.getCredAt(viewHolder.adapterPosition))
